...
I discretize the x − y plane with a 200 × 200 grid of physical size 1m × 1m. The magnetic field $\mathbf{B}$ points out of the page in the positive z direction. The plasma with a uniform number density of $10^{12}$ particles per $m^3$ is initialized in the center of the grid. The simulation implements periodic boundary conditions along the x-axis and conducting boundary conditions at $y = 0m$ and $y = 1m$.
...
for i in range (step):
    ...
    if i % frame_interval == 0:
        ...
        np.savez('example_run', **file_save) # save the data in an npz file
...
ani.save('example_run.gif', writer='pillow', fps=5) # save the frames to create the animation gif
