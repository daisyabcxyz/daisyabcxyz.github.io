...
This course teaches Linear Algebra by providing the basic tools so that students can use them to tackle more advanced problems, mostly involving proof writing. Although the tools seem basic and simple, they are the foundations of proofs and are useful in various ways. Thus, it takes creativity and flexibility to see how and where to apply them. 
...
$$v = V \begin{pmatrix} a_{1} \\ \vdots \\ a_{n} \end{pmatrix}$$
Essentially, matrix multiplication is a transformation tool used in computer graphics. We generate different geometric transformations by multiplying matrices together. For example, we can rotate something clockwise, reflect it over the y-axis, and stretch it by a factor of 3 all at once by multiplying the matrix of our original image with the product of the 3 matrices representing these transformations.
...
![Reflection across a plane in $\mathbb{R}^{3}$](reflection_plane.png){width=70% fig-align="center"}
