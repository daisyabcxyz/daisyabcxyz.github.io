...
![Figure 6: Tagging the photon's paths caused the wave function to collapse and the interference pattern to disappear. However, we could erase that distinguisher with a linear polarizer in front of B' and bring back the interference for that detector.](images_quantum/fig6.png){width="100%" fig-align="center"}
...
![Figure 7: Visibility of $R_{AB}$ and $R_{AB'}$ as a function of the path length difference with and without a $810 \pm 10$ nm bandpass filter in front of detector A. We set the baseline for interference to be at $V=0.2$ where the blue dotted line was and defined coherence length to be the range in which the visibility of the fringe was above that line.](images_quantum/fig7.png){width="100%" fig-align="center"}
